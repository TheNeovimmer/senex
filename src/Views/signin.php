...
<section class="section-padding px-3">
  <div class="container">
    <div class="row justify-content-center" data-aos="fade-up">
      <div class="col-lg-10">
        <h1 class="auth-heading-faded text-center mb-5">
          WELCOME BACK,<br>CHALLENGER!
        </h1>
        <div class="row g-0 shadow-lg overflow-hidden radius-lg">
          <div class="col-md-6 d-flex flex-column justify-content-center p-5 signup-left">
          ...
          <div class="col-md-6 p-5 signup-right">
            ...
            <p class="text-center mb-4 text-dark-secondary">Let's get you started</p>
            <form action="/signin" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control input-auth" placeholder="Enter your email" required>
              </div>
              <div class="mb-3">
                <label class="form-label fw-medium text-dark-primary">Username</label>
                <input type="text" name="username" class="form-control input-auth" placeholder="Choose a username" required>
              </div>
              <div class="mb-3">
                <label class="form-label fw-medium text-dark-primary">Password</label>
                <input type="password" name="password" class="form-control input-auth" placeholder="Create a password" required>
              </div>
              <div class="mb-4">
